      ...
      <div className="container">
            ...
            <Popover
              renderPopover={
                <div>
                  <Link
                    to={path.profile}
                    className="block text-left w-full py-2 px-3 hover:bg-slate-100 bg-white hover:text-cyan-500"
                  >
                    Tài khoản của tôi
                  </Link>
                  <Link
              ...
              className="flex ml-6 items-center py-1 hover:text-white/70 cursor-pointer"
            >
              <div className="w-5 h-5 mr-2 flex-shrink-0">
                <img
                  src="https://lh3.googleusercontent.com/ogw/AOLn63ECh0RrwNaDL0VMEmAoRpmEQc9uIGq0baJXGwZY=s32-c-mo"
                  alt="avatar"
        ...
        <div className="grid grid-cols-12 gap-4 mt-4 items-end">
          <Link to="/" className="col-span-2 ">
            <svg viewBox="0 0 192 65" className="fill-white h-11">
              <g fillRule="evenodd">
          ...
          <form className="bg-white rounded-sm p-1 flex col-span-9">
            <input
              ...
              placeholder="FREESHIP ĐƠN HÀNG TỪ 0Đ"
            />
          ...
          <div className="cols-span-1 justify-self-end">
            <Popover
              renderPopover={
                <div className="max-w-[400px] text-sm bg-white relative shadow-md rounded-sm border border-white">
                  <div className="p-2">
                    ...
                    <div className="mt-5">
                      <div className="mt-4 flex">
                        <div className="flex-shrink-0">
                          <img
                            src="https://down-vn.img.susercontent.com/file/b9f85097a7f18897e2f55a26c4904f11_tn"
                            alt="anh"
                        ...
                        <div className="flex-grow ml-2 overflow-hidden">
                          <div className="truncate">
                            USB 8GB 16GB 32GB 64GB Kim Loại Dung Lượng Đa Năng
                            Cho Máy Tính
                          </div>
                        </div>
                        <div className="ml-2 flex-shrink-0">
                          <span className="text-orange">₫79.000</span>
                        </div>
                      </div>
                      <div className="mt-4 flex">
                        <div className="flex-shrink-0">
